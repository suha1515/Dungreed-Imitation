...
public:
	...
	void DrawOnCanvas();
public:
	static void DrawMulti(int startX,int endX,int startY,int endY,Vertex p1, Vertex p2, Vertex p3, BitMap *bitmap, uint32_t colorMask,Rasterizer* rasterizer, ScreenCoordinate* ScreenCoord);
public:
