...
//Create DIB
void CRasterizer::CreateDIB(HDC hdc, int width, int heigth)
{
	m_iWidth = width;
	m_iHeight = heigth;
...
void CRasterizer::SetPixel(int x0, int y0, mRGB color)
{
...
void CRasterizer::SetPixel(int x0, int y0, uint32_t uint)
{
	if ((x0 >= 0 && x0 < m_iWidth) && (y0 >= 0 && y0 < m_iHeight))
	{
...
void CRasterizer::SetPixel(int x0, int y0, Color _color)
{
	if ((x0 >= 0 && x0 < m_iWidth) && (y0 >= 0 && y0 < m_iHeight))
	{
		uint32_t color = 0;
...
void CRasterizer::Present(HDC * hdc)
{
